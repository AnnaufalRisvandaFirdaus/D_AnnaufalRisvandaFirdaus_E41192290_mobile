...
public class MahasiswaAdapter extends RecyclerView.Adapter<MahasiswaAdapter.ViewHolder> {
    ...
    private ArrayList<com.arf.Tugas4.Mahasiswa> dataList;

    public MahasiswaAdapter(ArrayList<com.arf.Tugas4.Mahasiswa> dataList) {
    ...
    public void onBindViewHolder(@NonNull MahasiswaAdapter.ViewHolder holder, int position) {
        ...
        holder.txprodi.setText(dataList.get(position).getprodi());
